...
const routes: RouteConfig[] = [
  ...
  { path: '/accounts', component: AccountsContainer, children: [
    ...
    withMeta(2, { path: 'balance/:chainId/:address', name: 'balance-list', component: BalanceList }), // 시연용
  ...
  { path: '/account/:chainId/:address/:from/:contract/', component: AccountContainer, children: [
