<template>
  <ScrollView class="page detail-page">
    <ExportAccountDialog
      :visible="exportAccountDialogVisible"
      @close="exportAccountDialogVisible = false"
    />
    ...
    <div class="detail-bottom">
      <div class="content">
        <div class="detail-box">
          ...
          <StakeDetails :tokenPriceInfo="tokenPriceInfo" v-if="!isArg" />
          <NameDetails v-if="!isArg" />
        </div>
      </div>
    </div>
    <LoadingDialog
...
export default class AccountDetails extends Vue {
  ...
  get isArg() {
    return this.$route.params.from === 'arg';
  }
